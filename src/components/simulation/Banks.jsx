        ...
        <>
            <Simulation>
               ...
               <Carousel responsive={responsive} className="carousel">
                    <a href="https://www8.caixa.gov.br/siopiinternet-web/simulaOperacaoInternet.do?method=inicializarCasoUso"><div className="bank05"><div className="photo"></div><p>Caixa</p></div></a> 
