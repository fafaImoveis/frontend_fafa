        ...
        <>
            <Simulation>
               ...
               <Carousel responsive={responsive} className="carousel">
                    <a href="https://ww3.itau.com.br/imobline/novolayout/simuladores/simulador.aspx?IMOB_TipoBKL=&ident_bkl=pre&parceiro=0835"><div className="bank03"><div className="photo"></div><p>Caixa</p></div></a> 
